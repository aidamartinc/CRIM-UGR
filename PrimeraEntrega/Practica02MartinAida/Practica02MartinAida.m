...
% De las 256 letras del alfabeto sólo usamos las que aparecen en el 
...
% Código para comprimir fotograma2 con Huffman
[U, V] = size(fotograma2);
seq = reshape(fotograma2, 1, U * V);

% Calcula el histograma de la imagen original
histograma_original = histc(seq, 0:255);

% Comprime la imagen utilizando Huffman
Compr(seq, 255);
